                ...
                <div id="docs-card-content" class="flex items-start gap-6 lg:flex-col">
                  ...
                  <div class="pt-3 sm:pt-5 lg:pt-0">
                    ...
                    <p class="mt-4 text-sm/relaxed">
                      Welcome to Laravel latest version11
                    </p>
                  </div>
                </div>
...
import SideBar from '@/Components/AIDesign/SideBar.vue';
        ...
        <div class="w-full relative flex flex-row">
          <div ref="blogRef"
            ...
            <div class="flex flex-wrap justify-center lg:justify-start items-center gap-4 py-[32px]">
              <div class="tab-btn-1 flex w-[196px] h-[48px] gap-[12px] p-[12px] rounded-[6px] border-[1px] border-[#6245E7]">
                <h4 class="font-500 text-[16px]">Design with AI</h4>
              </div>
              <div class="tab-btn-2 flex h-[48px] gap-[12px] p-[12px] rounded-[6px] border-[1px] border-[#E4E7EC]">
                <h4 class="font-500 text-[16px]">Design with Template</h4>
              </div>
              <div class="tab-btn-3 flex h-[48px] gap-[12px] p-[12px] rounded-[6px] border-[1px] border-[#E4E7EC]">
                <h4 class="font-500 text-[16px]">Design Bulk banners</h4>
              </div>
              <div class="tab-btn-4 flex h-[48px] gap-[12px] p-[12px] rounded-[6px] border-[1px] border-[#E4E7EC]">
                <h4 class="font-500 text-[16px]">Design from scratch</h4>
              </div>
            </div>
            <div class="tab-wrap">
              <tabs>
                <tab class="tab-1">I am Tab-1</tab>
                <tab class="tab-2">I am Tab-2</tab>
                <tab class="tab-3">I am Tab-3</tab>
                <tab class="tab-4">I am Tab-4</tab>
              </tabs>
            </div>
