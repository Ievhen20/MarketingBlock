...
<template>
  ...
  <section>
    <div class="tab-content-1">
      ...
      <div
        :class="[
          'generate-form', 'flex', 'w-full', 'rounded-[8px]', 'bg-[#F9FAFB]', 'border-[1px]', 'border-[#D0D5DD]', 'text-[16px]', 'mt-[20px]', 
          {
            'flex-col': isTextareaLarge, 
            'flex-row': !isTextareaLarge,
            'outline-[2px]': isTextareaFocused,
            'outline-[#F4EBFF]': isTextareaFocused,
            'outline-offset-[0px]': isTextareaFocused,
            'border-primary-color': isTextareaFocused,
            'border-[1px]': isTextareaFocused,
          }
        ]"
      >
      ...
      <!-- Tab Navigation -->
      <div class="flex w-full border-b-[1px] border-b-[#E4E7EC] mt-[26px] mb-[20px] h-[40px] gap-[16px] text-[14px] font-[500] font-sans1">
